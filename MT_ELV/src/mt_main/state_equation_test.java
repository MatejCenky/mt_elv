...
// basic variables
     ...
     */
    private static double alpha = 18.9e-6;    
...
// values for state equation
    private static int ter = 1;            // specify flat / non-flat terrain - in constructor !!!;
    ...
    private static double z_1 = 1;         // conductor overload in state "1" [-]
    private static double theta_1 = -30;     // conductor temperature in state "1"
    private static double theta_0 = -5;     // conductor temperature in state "0"
    private static double sigma_h0 = 70.80;    // horizontal stress in conductor in state "0" [MPa]
...
// **************** PRIVATE METHODS **************** //
    ...
    private static void gama(){
        ...
        // test print out
        System.out.println("gama = " + state_equation_test.gama);
    }
    ...
    private static void mid_span_flat(){
        ...
        // test print out
        System.out.println("MSF = " + state_equation_test.MSF);
    }
    ...
    private static void mid_span_terrain(){
        ...
        // test print out
        System.out.println("MST = " + state_equation_test.MST);
    }
    ...
    private static void cubic_equation_solve(){
        ...
        // test print out
        System.out.println("Sigma_h1 = " + state_equation_test.sigma_h1);
    }
    ...
    private static void cubic_equation_coef_B(){
        ...
        // test print out
        System.out.println("Bc = " + state_equation_test.Bc);
    }
    ...
    private static void cubic_equation_coef_D(){
        ...
        state_equation_test.Dc = (-1)*Math.pow(state_equation_test.gama,2)*state_equation_test.E/24 * Math.pow(var*state_equation_test.z_1, 2);
    
        // test print out
        System.out.println("Dc = " + state_equation_test.Dc);
    }
    ...
    private static void pulling_force(){
        ...
        // test print out
        System.out.println("F_mh1 = " + state_equation_test.F_mH1);
    }
    ...
    private static void c_parameter(){
        ...
        // test print out
        System.out.println("c = " + state_equation_test.c);
    }
    ...
    private static void sag_maximum(){
        ...
        // test print out
        System.out.println("sag_max = " + state_equation_test.sag_max[0]);
    }
    ...
    private static void sag_visible(){
        ...
        // test print out
        System.out.println("sag_vis = " + state_equation_test.sag_vis[0]);
    }
    ...
    private static void cubic_equation_coef_B_imaginary(double t0, double tp){
        ...
        // test print out
        System.out.println("Bc_i = " + state_equation_test.Bc_i);
    }
    ...
    private static double cubic_equation_solve_imaginary(){
        ...
        // test print out
        System.out.println("cubic_imaginary = " + result);
