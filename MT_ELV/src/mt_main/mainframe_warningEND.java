...
import static mt_main.startPanel.end_of_programme;
 ...
 * @author Jozef
 */
public class mainframe_warningEND extends javax.swing.JDialog {

    /**
     * Creates new form Help_Math_JDialog
     */
    public mainframe_warningEND(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(language.language_label(languageOption,291));

        createButton.setText(language.language_label(languageOption,289));
    ...
    startPanel.end_of_programme=true;
       disinit();
    ...
    startPanel.end_of_programme=false;
       disinit();
    ...
    public  void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainframe_warningEND.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mainframe_warningEND dialog = new mainframe_warningEND(new javax.swing.JFrame(), true);
