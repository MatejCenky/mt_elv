...
public class mainframe_namrazova_oblast_jDialog_1 extends javax.swing.JDialog {
    ...
    private void button_setActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_setActionPerformed
        ...
        mainframe_19.hodnoty_namrazove_oblasti = hodnoty;
        
        if (rowNumber == 8){
        mainframe_19.namrazove_oblasti_názov_oblasti = "I-K";    
        }else{
        mainframe_19.namrazove_oblasti_názov_oblasti = String.valueOf(jTable.getValueAt(rowNumber, 0));
        }
        mainframe_19.is_namrazove_oblasti_setted=true;
        disinit();
       }else{
