 ...
 * @author Jozef
 */
public class mainframe_warning_jDialog extends javax.swing.JDialog {

    /**
     * Creates new form Help_Math_JDialog
     */
    public mainframe_warning_jDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public  void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainframe_warning_jDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mainframe_warning_jDialog dialog = new mainframe_warning_jDialog(new javax.swing.JFrame(), true);
